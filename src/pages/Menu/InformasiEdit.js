...
export default function InformasiEdit({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        axios.post(apiURL + 'update_informasi', kirim).then(res => {
    ...
    return (
        <SafeAreaView style={{
            ...
            <MyHeader title="Edit Berita & Info" onPress={() => navigation.goBack()} />
            <ScrollView showsVerticalScrollIndicator={false} style={{
                ...
                <MyPicker label="Jenis" value={kirim.tipe} iconname="options" onValueChange={x => setKirim({ ...kirim, tipe: x })} data={[
