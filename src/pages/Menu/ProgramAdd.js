...
export default function ProgramAdd({ navigation, route }) {
    ...
    const sendServer = () => {
        ...
        axios.post(apiURL + 'insert_program', kirim).then(res => {
    ...
    return (
        <SafeAreaView style={{
            ...
            <MyHeader title="Tambah Program" onPress={() => navigation.goBack()} />
